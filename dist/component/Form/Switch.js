...
class Switch extends _react.PureComponent {
  constructor(...args) {
    var _this,
        _arrowCheckId = {},
        _arrowCheckId2 = {};
  ...
  render() {
    ...
    return _react.default.createElement("div", {
      className: "accordium input-field switch",
      ...
      className: "switch"
    }, _react.default.createElement("label", null, label, _react.default.createElement("input", {
      type: "checkbox",
      name: name,
      checked: isChecked,
      onChange: onChange,
      ...
      className: "lever"
    }))), this.props.children, tooltip && _react.default.createElement("div", {
