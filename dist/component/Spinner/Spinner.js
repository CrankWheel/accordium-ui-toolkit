  ...
  render() {
    const _this$props = this.props,
      ...
      inverted
          ...
          rest = _objectWithoutProperties(_this$props, ["className", "style", "text", "inverted"]);

    const styling = (0, _classNames.default)('accordium loading-spinner', className, {
      inverted
    });
    return _react.default.createElement("div", _extends({
      ...
      className: styling,
      style: style
    }, rest), _react.default.createElement(_SVGIcons.LoadingSpinner, null), text && ` ${text}`));
  }
