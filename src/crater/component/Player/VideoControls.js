...
const PlayButtonIcon = memo(props => {
  ...
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 32 32" style={style} className={className}>
...
const RoundedPlayIcon = memo(props => {
  const { style, className, ...rest } = props;
  return (
    <svg width="84px" height="84px" viewBox="0 0 84 84" version="1.1" style={style} className={className} {...rest}>
      <defs>
        <path
      ...
      <g id="Page-1" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
        <g id="Version-4-:-Test-with-new-input-fields" transform="translate(-674.000000, -263.000000)">
          <g id="Play-Button" transform="translate(674.000000, 263.000000)">
            <g id="Icons-/-1-Primary-/-Media-/-Video-/-01-Play" transform="translate(33.000000, 25.000000)">
              <mask id="mask-2" fill="white">
                <use xlinkHref="#rounded-play-inner-icon" />
              </mask>
              <use id="fill" fill="#FFFFFF" fillRule="nonzero" xlinkHref="#rounded-play-inner-icon" />
            </g>
            <circle id="Oval" fill="#FFFFFF" opacity="0.251929874" cx="42" cy="42" r="42" />
          </g>
        </g>
      </g>
    </svg>
...
export { PlayButtonIcon, VolumeIcon, FullscreenIcon, DownloadIcon, MuteIcon, PauseIcon, RoundedPlayIcon };
